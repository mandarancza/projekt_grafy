...
def znajdz_najkrotszy_cykl_skierowany(graph):
...
class GraphCycleApp:
    def __init__(self, master):
        self.master = master
        master.title("Wyszukiwarka Najkrótszego Cyklu w Grafie Skierowanym")
    ...
    def process_graph_and_draw(self):
        ...
        dlugosc, sciezka = znajdz_najkrotszy_cykl_skierowany(self.current_graph_dict)
...
def main():
    ...
    # Ustaw ikonę aplikacji (opcjonalnie, wymaga pliku .ico lub .xbm)
    # try:
    #     root.iconbitmap('path/to/your/icon.ico') # Dla Windows
    # except tk.TclError:
    #     try:
    #         img = tk.PhotoImage(file='path/to/your/icon.gif') # Dla innych systemów, GIF jest bardziej uniwersalny
    #         root.tk.call('wm', 'iconphoto', root._w, img)
    #     except tk.TclError:
    #         print("Nie można załadować ikony aplikacji.")
